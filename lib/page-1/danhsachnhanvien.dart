...
// Nhưng biến phục vụ chức năng search
  ...
  final CollectionReference updataNV =FirebaseFirestore.instance.collection('Staff');
  bool sapXepNV = true;
            ...
            children: [
                        ...
                        child: Row(
                          ...
                          children: [
                              ...
                              child: GestureDetector(
                                onTap: (){
                                  Navigator.of(context).push(
                                    MaterialPageRoute(
                                      builder: (context) =>  ThemNhanVien(updateProductStreamNV: updateProductStreamNV),
                                    ),
                                  );
                                },
                                child: Row(
                            ...
                            GestureDetector(
                              onTap: (){
                                setState(() {
                                  sapXepNV = false; // Đảo ngược trạng thái sắp xếp
                                });
                              },
                              child: Row(
                                children: [
              ...
              Expanded(
                  child: StreamBuilder<QuerySnapshot>(
                      stream: sapXepNV ?  productStreamNV : updataNV.orderBy('tenNV').snapshots(),
                      builder: (context,snapshot) {
                        ...
                        filteredSearchNV = nguyenlieu.where((nguyenLieu) =>
                            nguyenLieu['tenNV'].toString().toLowerCase().contains(searchKeyNV.toLowerCase())
                        ).toList();
                        ...
                        return ListView.builder(
                          // đưa dữ liệu hiển thị lên màn hình
                            ...
                            itemBuilder: (context, document){
                              final DocumentSnapshot documentSnapshotNV = filteredSearchNV[document];
                                ...
                                SizedBox(
                                  ...
                                  child: Card(
                                    child: ListTile(
                                      ...
                                      onTap: (){
                                        Navigator.of(context).push(MaterialPageRoute(builder: (context)=> ChiTietNhanVien(NhanVienID: id),),);
                                      },
                                      ...
                                      trailing: Column(
                                        ...
                                        children: [
                                          GestureDetector(
                                            onTap: () {
                                              Navigator.push(context, CupertinoPageRoute(builder: (context)=>
                                                  SuaNhanVien(
                                                      calam: documentSnapshotNV['caLam'],
                                                      hinhAnh: documentSnapshotNV['hinhAnh'],
                                                      luong: documentSnapshotNV['luong'].toString(),
                                                      ngaySinh: documentSnapshotNV['ngaySinh'],
                                                      sodienthoai:documentSnapshotNV['sdt'],
                                                      tenNV: documentSnapshotNV['tenNV'],
                                                      gioiTinh: documentSnapshotNV['gioiTinh'],
                                                      id: documentSnapshotNV.id))
                                              );
                                            },
                                            child: Container(
                                              // bteditbTw (5:459)
                                          ...
                                          Container(
                                            ...
                                            child: TextButton(
                                              onPressed: (){
                                                confirmDeleteDialogNV(updataNV.doc(documentSnapshotNV.id));
                                              },
                                              child: Image.asset(
