...
class _DatHangState extends State<DatHang> {
  ...
  String defaultNgaySinh = DateFormat('dd/MM/yyyy HH:mm:ss').format(DateTime.now());
  ...
  void initState() {
    super.initState();
    getUserInfo();
    calculateTotalAmount().then((value) {
      setState(() {
        tonghoadon = value;
      });
    });
  }
  final CollectionReference updataDatHang =FirebaseFirestore.instance.collection('Cart');
  ...
  Widget buildGooglePayButton() {
    return GooglePayButton(
      ...
      onPaymentResult: (result) async {
        debugPrint('Payment Result $result ');
        Fluttertoast.showToast(msg: 'Thanh toán thành công');
        Navigator.of(context).push(MaterialPageRoute(builder: (context)=> QuanLyKH()));
        try {
                      ...
                      child: Container(
                        ...
                        child: Row(
                          ...
                          children: [
                            Container(
                              // frame82E6L (180:462)
                              margin: EdgeInsets.fromLTRB(2*fem, 10*fem, 30*fem, 5*fem),
                              padding: EdgeInsets.fromLTRB(10*fem, 0*fem, 9*fem, 6*fem),
                              height: 50,
                              width: 135,
                              decoration: BoxDecoration (
                                color: Color(0xff993300),
                              ...
                              child: Row(
                                ...
                                children: [
                                  Container(
                                    // eurosj36 (180:463)
                                    margin: EdgeInsets.fromLTRB(5*fem, 8*fem, 9*fem, 3*fem),
                                    width: 20*fem,
                                    height: 20*fem,
                                    child: Image.asset(
                                  ...
                                  Center(
                                    ...
                                    child: GestureDetector(
                                      onTap: () async{
                                        ...
                                        Fluttertoast.showToast(msg: 'Bạn đã đặt hàng thành công, chờ thanh toán bằng tiền mặt');
                            ...
                            Container(
                              padding: EdgeInsets.fromLTRB(10 * fem, 0 * fem, 1 * fem, 6.5 * fem),
                              ...
                              child: Column(
                                mainAxisAlignment: MainAxisAlignment.end, // Điều chỉnh căn giữa hoặc căn đều theo ý muốn
                                children: [
                                      ...
                                      Column(
                                        ...
                                        children: [
                                          ...
                                          Container(
                                            ...
                                            child: TextButton(
                                              onPressed: (){
                                                confirmDeleteDialog(updataGioHang.doc(documentSnapshotGioHang.id));
                                              },
                                              child: Image.asset(
        ...
        return AlertDialog(
          ...
          actions: <Widget>[
            TextButton(
              ...
              onPressed: () {
                Navigator.of(context).push(MaterialPageRoute(builder: (context)=> const DatHang()));
              },
            ),
            TextButton(
