...
class ThemNhanVien extends StatefulWidget {
  ...
  const ThemNhanVien({Key? key, required this.updateProductStreamNV});
...
class _ThemNhanVienState extends State<ThemNhanVien> {
  ...
  uploadImageNV(String id) async {
    final storageRef = FirebaseStorage.instance.ref().child("nhanVien");
    try {
  ...
  Future addnewStaff(NhanVien nhanvien) async {
    ...
    try {
      ...
      Fluttertoast.showToast(
          msg: 'Thêm thất bại', backgroundColor: Colors.red);
    }
  }
            ...
            child: Padding(
              ...
              child: Material(
                ...
                child: SizedBox(
                  ...
                  child: Container(
                    padding: EdgeInsets.fromLTRB(16 * fem, 16 * fem, 17 * fem, 0),
                    width: double.infinity,
                    ...
                    child: SingleChildScrollView(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Container(
                            margin: EdgeInsets.fromLTRB(10 * fem, 0, 9 * fem, 0),
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                Container(
                                  margin: EdgeInsets.fromLTRB(0, 0, 0, 25 * fem),
                                  width: 259 * fem,
                                  height: 110 * fem,
                                  child: TextButton(
                                    onPressed: () async {
                                    ...
                                    child: imageNV != null
                                        ? Image.file(File(imageNV!.path), width: 259 * fem, height: 110 * fem)
                                        : Image.asset(
